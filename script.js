...
const first_arguments = [
  ...
  { text: "Кто ты?", meta: {} },
  { text: "Что ты такое?", meta: {} },
  { text: "Из чего ты сделан?", meta: {} },
  { text: "Что у тебя внутри?", meta: {} },
  { text: "Что у тебя на уме?", meta: {} },
  { text: "Что у тебя на душе?", meta: {} },
  { text: "Твое время вышло!", meta: {} },
  { text: "Ты трусливый грешник!", meta: {} },
...
const second_arguments = [
  ...
  { text: " Ты сошел с пути.", meta: {} },
  { text: " У тебя в кармане чужое бабло!", meta: {} },
  { text: " Ты не умеешь хранить секреты!", meta: {} },
  { text: " Не играй со мной!", meta: {} },
...
const snd = document.getElementById("send");
